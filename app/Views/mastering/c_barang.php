            ...
            <form class="form-horizontal" action="<?= base_url('/mbarang/s_barang'); ?>" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('kbar'); ?>" type="text" class="form-control <?= ($validation->hasError('kbar')) ? 'is-invalid' : ''; ?>" id="kbar" name="kbar" placeholder="Kode Barang" autofocus />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('nbar'); ?>" type="text" class="form-control <?= ($validation->hasError('nbar')) ? 'is-invalid' : ''; ?>" id="nbar" name="nbar" placeholder="Nama Barang" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('stok'); ?>" type="text" class="form-control <?= ($validation->hasError('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok Barang" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-select shadow-none" name="jbar" required>
                                ...
                                <option value="Aset Ekstrakomtabel">Aset Ekstrakomtabel</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('merk'); ?>" type="text" class="form-control <?= ($validation->hasError('merk')) ? 'is-invalid' : ''; ?>" id="merk" name="merk" placeholder="Merk" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('type'); ?>" type="text" class="form-control <?= ($validation->hasError('type')) ? 'is-invalid' : ''; ?>" id="type" name="type" placeholder="Tipe" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('tgl_beli'); ?>" type="text" class="form-control text-muted <?= ($validation->hasError('tgl_beli')) ? 'is-invalid' : ''; ?>" id="datepicker-autoclose" name="tgl_beli" placeholder="yyyy-mm-dd" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input required value="<?= old('harga'); ?>" type="text" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" name="harga" placeholder="Harga" />
